					...
					<xsl:for-each select="child::*[name(.)='eb:ListLineItem']">
						<xsl:if test="count(preceding-sibling::*[name()='eb:ListLineItem'])=0">
							<tr>
								...
								<th class="tright">USt<xsl:if test="@eb:TaxCode"> (<xsl:value-of select="@eb:TaxCode"/>)</xsl:if></th>
						...
						<tr>
							...
							<td class="tright"><xsl:value-of select="eb:Quantity"/>&#160;<xsl:value-of select="eb:Quantity/@eb:Unit"/></td>
