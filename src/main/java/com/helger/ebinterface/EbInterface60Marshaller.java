...
/**
 * This is the reader and writer for ebInterface 6.0 documents. This class may
...
public class EbInterface60Marshaller extends GenericJAXBMarshaller <Ebi60InvoiceType>
{
   ...
   */
  public EbInterface60Marshaller (@Nonnull final List <ClassPathResource> aXSDs)
  {
    super (Ebi60InvoiceType.class, aXSDs, o -> new ObjectFactory ().createInvoice (o));
