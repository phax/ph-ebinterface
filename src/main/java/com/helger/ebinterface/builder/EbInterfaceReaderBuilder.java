 ...
 */
@NotThreadSafe
public class EbInterfaceReaderBuilder <JAXBTYPE>
                                      extends JAXBReaderBuilder <JAXBTYPE, EbInterfaceReaderBuilder <JAXBTYPE>>
{
  public EbInterfaceReaderBuilder (@Nonnull final EEbInterfaceDocumentType eDocType,
                                   @Nonnull final Class <JAXBTYPE> aImplClass)
  {
    super (eDocType, aImplClass);
  }

  public EbInterfaceReaderBuilder (@Nonnull final Class <JAXBTYPE> aClass)
  {
